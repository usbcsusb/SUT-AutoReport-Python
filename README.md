...
# [SUT打卡自动化——基于Python requests](https://github.com/usbcsusb/SUT-AutoReport-python-request)

![GitHub last commit](https://img.shields.io/github/last-commit/usbcsusb/SUT-AutoReport-python-request)
![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/usbcsusb/SUT-AutoReport-python-request)  
