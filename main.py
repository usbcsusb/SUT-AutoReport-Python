...
# 定义配置(被调用) "+ +"
user_account = os.environ["SCKEY1"]  # 学号
user_password = os.environ["SCKEY2"]  # 身份证后六位
mqszd = os.environ["SCKEY3"]  # 目前所在地 填写 "沈阳市" 、 "辽宁省非沈阳市" 、"其他地区（非辽宁省）"
sfybh = os.environ["SCKEY4"] # 前一日填报到目前为止，目前所在地（第 1 题）是否存在变化？ 填写 “是” 、 “否”
jrcltw = os.environ["SCKEY5"] # 今日测量体温
sjhm = os.environ["SCKEY6"]  # 请填写目前个人手机号码
jrlxfs = os.environ["SCKEY7"]  # 请填写家人联系方式
zddw1 = os.environ["SCKEY8"]  # 目前所在地第一行
zddw2 = os.environ["SCKEY9"]  # 目前所在地第二行
# 微信推送 key 在 https://sct.ftqq.com/login 中使用微信扫码获取，信息会推送到你扫码的微信号上。
SendKey = os.environ["SCKEY10"]
